...
export class NgIdleService implements OnDestroy {
  ...
  private initListener(): void {
    this.zone.runOutsideAngular(() => {
      ...
      window.document.addEventListener('DOMMouseScroll', this.userActivityChangeCallback.bind(this), true);
      window.document.addEventListener('MSPointerMove', this.userActivityChangeCallback.bind(this), true);
      window.document.addEventListener('mousewheel', this.userActivityChangeCallback.bind(this), true);
